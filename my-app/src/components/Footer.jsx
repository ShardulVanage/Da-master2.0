...
function Footer() {
  return (
<footer className="footer justify-evenly items-center p-4 bg-blue-500 text-white py-4 ">
  <aside className="justify-center items-center  flex flex-row">
    ...
    <p className='px-4'>Copyright © 2024 - All right reserved</p>
  </aside> 
