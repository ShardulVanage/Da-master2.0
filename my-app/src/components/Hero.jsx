...
function Hero() {
  return (
    <section className='h-full sm:h-screen bg-slate-300 flex flex-col justify-center items-center '>
        <div className='flex flex-row  justify-center items-center py-8'>
            ...
            <h2 className='text-3xl sm:text-6xl w-full sm:w-4/6 font-bold py-4  text-center '>Unleash Your Data Superpowers and Guarantee Your Career Success with a <span className='bg-clip-text text-transparent  bg-gradient-to-r from-rose-400/60 via-fuchsia-500/60 to-indigo-500/60'>100%</span> Placement Promise</h2>
 <div className= 'bg- flex  flex-col sm:flex-row  justify-center items-center'>
    <div className='w-full sm:w-3/12 border-t-2 border-l-2 border-solid p-8 sm:ml-0 ml-4 '>
