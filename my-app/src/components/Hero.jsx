...
function Hero() {
  return (
    <section className=' sm:h-screen bg-slate-300 flex flex-col justify-center items-center '>
 ...
 <div className= 'bg- flex  flex-col sm:flex-row  justify-center items-center'>
    <div className='w-full sm:w-5/12 border-t-2 border-l-2 border-solid p-8 sm:ml-0 ml-4 '>
